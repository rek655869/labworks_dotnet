...
namespace LW_08_App
{
    public partial class Ex_1 : UserControl
    {
        ...
        {
            FileStream file = new FileStream("C:\\Users\\STALKER\\source\\repos\\LW_08_App\\file.txt", FileMode.OpenOrCreate); //создаем файл
            ...
            writer.WriteLine();
            writer.Close();
            FileStream file1 = new FileStream("C:\\Users\\STALKER\\source\\repos\\LW_08_App\\file.txt", FileMode.Open); //открываем файл
